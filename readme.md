...
- 🚨 **Over-limit Interest (AD)**  
  Known locally as *"Adiantamento a Depositante"*, this interest is charged on any usage that exceeds the customer’s overdraft limit.
...
### ⚠️ Case 5: Exceeded Overdraft Limit
